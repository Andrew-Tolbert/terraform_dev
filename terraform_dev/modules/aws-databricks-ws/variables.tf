...
variable "workspace_name" {
  type        = string
  default     = ""
  description = "(Optional) Workspace Name for this module - if none are provided, the prefix will be used to name the workspace via a conditional"
}

variable "deployment_name" {
  type        = string
  default     = ""
  description = "(Optional) Workspace URL prefix for this module - if none are provided, the prefix will be used to name the workspace via a conditional"
}
